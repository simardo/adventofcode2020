...
doPart12([...'389125467'].map(n => Number.parseInt(n)), 10, false);
doPart12([...'389125467'].map(n => Number.parseInt(n)), 100, false);
doPart12([...'598162734'].map(n => Number.parseInt(n)), 100, false);

doPart12([...'389125467'].map(n => Number.parseInt(n)), 10000000, true);
